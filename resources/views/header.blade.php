    ...
    <header>
            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-6">
                        <ul id="top_links">
                            @auth
                                <li><a href="{{ route('login') }}" id=" access_link"> {{ Auth::user()->name }}</a></li>
                            ...
                            @endauth
                            @if (!Auth::user())
                                <li><a href="{{ route('login') }}" id=" access_link">Sign in</a></li>
                                <li><a href="{{ route('register') }}" id=" access_link">register</a></li>
                            @endif
        ...
        <div class="container">
            <div class="row">
                <div class="col-3">
                    <div id="logo_home">
                        <h1><a href="{{ url('/') }}" title="City tours travel template">City Tours travel
                                template</a></h1>
                    </div>
                </div>
                <nav class="col-9">
                    ...
                    <div class="main-menu">
                        <div id="header_menu">
                            <img src="front/img/logo_sticky.png" width="160" height="34" alt="City tours"
                                data-retina="true">
                        </div>
                        ...
                        <li>
                            <div class="dropdown dropdown-cart">
                                ...
                                <ul class="dropdown-menu" id="cart_items">
                                    <li>
                                        <div class="image"><img src="front/img/thumb_cart_1.jpg" alt="image">
                                        </div>
                                        <strong><a href="#">Louvre museum</a>1x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="front/img/thumb_cart_2.jpg" alt="image">
                                        </div>
                                        <strong><a href="#">Versailles tour</a>2x $36.00 </strong>
                                        <a href="#" class="action"><i class="icon-trash"></i></a>
                                    </li>
                                    <li>
                                        <div class="image"><img src="front/img/thumb_cart_3.jpg" alt="image">
                                        </div>
